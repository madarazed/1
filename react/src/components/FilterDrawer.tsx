...
import { X, Tag, SlidersHorizontal, Check, Search } from 'lucide-react';
...
const FilterDrawer = ({
  ...
  const filteredBrands = useMemo(() => {
    return availableBrands.filter(m => 
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-9 pr-4 py-2.5 bg-gray-50 border border-gray-100 rounded-xl text-xs font-bold text-primary outline-none focus:ring-2 focus:ring-primary/10 transition-all"
                  />
                </div>
                ...
                <div className="max-h-60 overflow-y-auto pr-2 space-y-2 scrollbar-hide">
                  ...
                  {filteredBrands.length > 0 ? (
                    ...
                    <div className="py-8 text-center">
                      <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">No se encontraron marcas</p>
                    </div>
                  )}
                </div>
              </div>
